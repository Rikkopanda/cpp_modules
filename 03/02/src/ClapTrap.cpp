...
{
	std::cout << Blue;
	std::cout << "ClapTrap " << White << name << Blue << " parameter constructor called" << std::endl;	std::cout << Default_restore;
	this->name = name;
	attack_damage = CLAP_ATTACK_DAMAGE;
	hit_points = CLAP_HIT_PTS;
	energy_points = CLAP_ENERGY_PTS;
...
{
	std::cout << Blue;
	std::cout << "ClapTrap copy constructor operator called" << std::endl;	std::cout << Default_restore;
	*this = src;
}
...
{
	std::cout << Blue;
	std::cout << "ClapTrap " << White << name << Blue << " destructor called" << std::endl;
	std::cout << Default_restore;
}
...
void	ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << "ClapTrap " << White << name << Blue << " attacks " << target
			<< ", causing " << attack_damage << " points of damage!" << std::endl;
		energy_points--;
	}
	else if (energy_points == 0)
		std::cout << "ClapTrap " << White << name << Blue << " has no energy points left to attack" << std::endl;
	else
		std::cout << "ClapTrap " << White << name << Blue << " has no hit points left to attack" << std::endl;
	std::cout << Default_restore;
}
